...
const authCheck = jwt({
    secret: jwks.expressJwtSecret({
        ...
        jwksUri: "https://irie-dready.eu.auth0.com/.well-known/jwks.json" // @TODO: remove domain name
    }),
    audience: 'http://localhost:3001', // https://irie-dready.eu.auth0.com/https://kmaida.auth0.com/", // @TODO: remove domain name
    algorithms: ['RS256']
});
